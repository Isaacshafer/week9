...
let annualUseKw = 0, dailyUseKw = 0, x = 0, i = 0
...
return x}
    ...
    console.log(panelName, panelOutput)

    let panelsNeeded = Math.ceil(realWattNeeds / panelOutput)
    console.log(panelsNeeded)

    let feedback = ""
    feedback += "<p>Based on your average daily use of "+Math.round(dailyUseKw) +"kWh, you will need to purchase "+ panelsNeeded +" "+ panelName + " solar panels to offset 100% of your electricity bill"
    feedback += '<h2> Additional Details</h2>'
    feedback += '<p>Your average daily electricity consumption: '+Math.round(dailyUseKw)+' kWh'
    feedback += '<p> Average sunshine hours per day : ' +sunHoursPerDay+ " hours </p>"
    feedback+= 'Realistic watts needed per hour : ' + Math.round(realWattNeeds)+" watts/hour</p>"
    feedback += "The "+panelName+" panel you selected genereates about "+panelOutput+" watts/hour."
